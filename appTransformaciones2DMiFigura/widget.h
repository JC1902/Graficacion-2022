...
private:
    ...
    float Fig[60][3]; // FIGURA ORIGINAL
    float FigAux[60][3]; // FIGURA DE RESPALDO
    float Planeta[45][3];

    int tamano = sizeof(Fig)/sizeof (Fig[0]);//obtener el número de puntos

    int ancho;
    int centroX;
    int centroY;

    int tX, tY, sX, sY, an, aleatorio, aleatorioY;
